...
submitBtn.addEventListener("click", (e) => {
	...
	if (!bookTitle.validity.valid) {
		console.log("invalid");
		bookTitle.setCustomValidity("Please enter a name for book title");
		bookTitle.reportValidity();
	} else if (!bookAuthor.validity.valid) {
		bookAuthor.setCustomValidity("Please enter a name of author");
		bookAuthor.reportValidity();
	} else if (!bookPages.validity.valid) {
		bookPages.setCustomValidity("please enter a number of book pages");
